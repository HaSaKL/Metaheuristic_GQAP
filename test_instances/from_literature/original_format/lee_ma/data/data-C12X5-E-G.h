...
const char FILE_NAME[]="result_C12X5-E-G.txt";
...
double Space_Avail[LOCATION_NUM]={65,120,80,180,350};
const double Space_Avail_Const[LOCATION_NUM]={65,120,80,180,350};
