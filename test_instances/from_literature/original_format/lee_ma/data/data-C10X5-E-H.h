...
const char FILE_NAME[]="result_10X5-E-H.txt";  /*for the output of the program*/ 
...
const double Space_Need[PROCESS_NUM]={10,20,30,40,50,65,70,80,55,45};

double Space_Avail[LOCATION_NUM]={120,120,125,120,125};
const double Space_Avail_Const[LOCATION_NUM]={120,120,125,120,125};
