...
#define LOCATION_NUM 3
#define BIG_IN_FEASIBLE 10000.0


const char FILE_NAME[]="result_C12X3-F-H.txt";
...
const double Distance[LOCATION_NUM][LOCATION_NUM]
                   ={{0,100,150},         /*row i means ith location, column j means jth location*/
                     {100,0,80},          /*Distance[i][j] means the distance from ith location to jth location*/
	             {150,80,0},
	              };

const double Space_Need[PROCESS_NUM]={70,65,55,60,75,65,70,55,65,80,60,65};

double Space_Avail[LOCATION_NUM]={260,280,310};
const double Space_Avail_Const[LOCATION_NUM]={260,280,310};
