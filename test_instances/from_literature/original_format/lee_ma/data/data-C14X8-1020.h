...
const char FILE_NAME[]="result_C14X8-E-G-1020.txt";

const double Unit_Transportation_Fee=5;

const double Installation_Cost[PROCESS_NUM][LOCATION_NUM]
={{50000,133000,75000,160000,35000,50000,30000,79000},
{55000,131500,167000,90000,276000,46700,119550,69000},
{95000,189500,119500,59870,145600,42000,139800,89000},
{25000,37500,31500,150000,70000,99000,127800,67500},
{29500,185000,145000,34500,150000,74000,122300,78600},
{75000,120500,19500,60000,210000,33200,133000,86000},
{115000,35000,27500,65000,97000,46800,56800,69800},
{84500,39500,28500,72000,250000,95000,67800,75000},
{25000,34500,113500,78900,65000,52100,23100,80000},
{74500,39500,20500,65000,84000,55000,29000,84320},
{50500,150000,39000,89000,220000,65000,25600,60000},
{58000,75500,70000,34200,45000,51000,27600,87000},
{25000,135000,37500,45000,157000,36800,120000,69000},
{34500,239500,78500,92000,145000,65000,22000,75900},
		 };
...
const float Distance[LOCATION_NUM][LOCATION_NUM]
                   ={{0,60,150,60,50,80,160,120},         /*row i means ith location, column j means jth location*/
                     {60,0,80,40,90,120,100,120},          /*Distance[i][j] means the distance from ith location to jth location*/
	             {150,80,0,70,120,70,80,110},
	             {60,40,70,0,60,80,90,100},
	             {50,90,120,60,0,50,100,120},
                 {80,120,70,80,50,0,60,130},
                 {160,100,80,90,100,60,0,100},
                 {120,120,110,100,120,130,100,0},
                  };

const float Space_Need[PROCESS_NUM]={85,140,120,50,130,75,85,30,60,40,110,40,50,75};

float Space_Avail[LOCATION_NUM]={250,80,100,345,70,140,80,90};
