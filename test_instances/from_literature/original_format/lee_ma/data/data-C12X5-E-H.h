...
const char FILE_NAME[]="result_C12X5-E-H.txt";

const double Unit_Transportation_Fee=5;

const double Installation_Cost[PROCESS_NUM][LOCATION_NUM]
={{10000,33000,75000,60000,45000},
{55000,31500,50000,90000,76000},
{95000,39500,19500,59870,45600},
{65000,37500,41500,100000,70000},
{29500,85000,45000,34500,50000},
{35000,57500,39500,60000,20000},
{115000,35000,27500,65000,67000},
{84500,39500,48500,12000,50000},
{45000,34500,13500,78900,65000},
{74500,39500,28500,65000,54000},
{50500,150000,59000,89000,120000},
{58000,25500,70000,34200,45000},
		 };
...
const double Distance[LOCATION_NUM][LOCATION_NUM]
                   ={{0,100,150,100,100},         /*row i means ith location, column j means jth location*/
                     {100,0,80,60,90},          /*Distance[i][j] means the distance from ith location to jth location*/
	             {150,80,0,70,80},
	             {100,60,70,0,40},
                 {100,90,80,40,0}
	            };

const double Space_Need[PROCESS_NUM]={10,20,30,40,50,65,70,100,80,90,60,55};

double Space_Avail[LOCATION_NUM]={115,145,145,150,135};
const double Space_Avail_Const[LOCATION_NUM]={115,145,145,150,135};
