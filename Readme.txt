...
The folder "algorithm" holds all source codes to compile a couple of GRASP-based applications which solve the Generalized Quadratic Assignment Problem
...
FIXME: describe applications used for tests 

FIXME: Check and fix parameters - these are from the SMP2_GRASP-Algorithm
	parameter description	Example(s) for usage
