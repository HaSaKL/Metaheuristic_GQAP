...
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=r --PRPoolSelect=r --PRDir=f
...
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=r --PRPoolSelect=d --PRDir=f
...
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=r --PRPoolSelect=r --PRDir=b

echo "Reactive Init, first Improvement LS, backward PR with random PoolSelect and greedy selection"
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=g --PRPoolSelect=r --PRDir=b

echo "Reactive Init, first Improvement LS, backward PR with diverse PoolSelect and random selection"
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=r --PRPoolSelect=d --PRDir=b
...
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=r --PRPoolSelect=r --PRDir=m
...
./GRASP_Solver_T2T --seed=19141108 --problemFile="20-15-35.txt" -r=250 --resultsFile="Test-20-15-35-PR1.csv" --stoppingCriterion=v -v=1471896 --LSStrategy=f --StartSol=U --minAlpha=0 --maxAlpha=1 --numAlpha=10 --PRMeth=r --PRPoolSelect=d --PRDir=m
