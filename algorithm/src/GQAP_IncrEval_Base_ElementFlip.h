#ifndef GQAP_INCREVAL_BASE_ELEMENTFLIP
#define GQAP_INCREVAL_BASE_ELEMENTFLIP

#include "GQAP.h"

class GQAP_IncrEval_Base_ElementFlip
{
public:
	// actual Calculation
	double CalculateIncrCosts (int equipment, int newLocation, int oldLocation, GQAP* & _problem) {
...
#endif // GQAP_INCREVAL_BASE_ELEMENTFLIP
